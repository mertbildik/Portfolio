...
Keep this close to the current density: greeting, one line, tagline. Nothing else.
...
The homepage is the work index. Four entries, two groups, text-led. Each entry is a short
introduction, not a preview of the case study.
...
>
> I started in computer science, graduated in International Relations, and found my way back
> to building things through design. The longer version is worth two minutes.
...
See `contact.md` — the same block is used here and on `/about`.
