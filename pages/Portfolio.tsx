            ...
            >
              <Link to={`/portfolio/${project.id}`}>
                <motion.div
                  ...
                  className="group relative w-full min-h-[500px] lg:min-h-[600px] p-8 md:p-12 rounded-3xl bg-dark-sec/80 backdrop-blur-xl border border-white/5 hover:border-white/20 transition-all duration-500 shadow-2xl flex flex-col justify-between overflow-hidden cursor-pointer"
                >
                  {/* Background Effects */}
