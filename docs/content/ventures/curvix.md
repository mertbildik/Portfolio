...
Editorial reference only. Published copy lives in `src/case-studies/studies/CurvixCaseStudy.tsx`.
...
- **Role:** Founder
- **Status:** Current
- **Page:** Hand-written case study (`src/case-studies/studies/CurvixCaseStudy.tsx`)
